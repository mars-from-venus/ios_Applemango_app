...
class HotBoardDetail: UIViewController {
...
//    }
    ...
    override func viewDidLoad() {
        ...
        myTable.rowHeight = 101
        myTable.layer.borderColor = UIColor.appColor(.backGray).cgColor
...
extension HotBoardDetail: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "myCell", for: indexPath) as! HotBoardDetailCell
